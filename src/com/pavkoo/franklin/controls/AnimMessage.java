...
public class AnimMessage extends LinearLayout {
	...
	private final int WAITTINGTIMEOUT = 3 * 60 * 1000;
	private final int LONGINFOTIMEOUT = 3 * 60 * 1000;
	...
	public void showMessage(String msg, AnimMessageType type) {
		...
		switch (type) {
			...
			case Waitting :
				...
				break;
			case LONGINFO :
				myHandle.sendEmptyMessageDelayed(CLOSEMESSAGE, LONGINFOTIMEOUT);
				endColor = getContext().getResources().getColor(R.color.white_app_bg_primary);
				break;
		}
	...
	public enum AnimMessageType {
		INFO, WARNING, ERROR, Hint, Waitting, LONGINFO
	}
}
