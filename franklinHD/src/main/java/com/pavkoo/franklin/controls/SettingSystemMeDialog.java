				...
				UmengUpdateAgent.setUpdateListener(new UmengUpdateListener() {
				    ...
				    public void onUpdateReturned(int updateStatus,UpdateResponse updateInfo) {
				        ...
				        case UpdateStatus.No: // has no update
				        	amMessage.showMessage(getContext().getString(R.string.no_update));
				            break;
				        case UpdateStatus.NoneWifi: // none wifi
				        	amMessage.showMessage(getContext().getString(R.string.no_wifi),AnimMessageType.ERROR);
				            break;
				        case UpdateStatus.Timeout: // time out
				        	amMessage.showMessage(getContext().getString(R.string.timeout),AnimMessageType.ERROR);
				            break;
				        }
				    }
				});
				UmengUpdateAgent.forceUpdate(SettingSystemMeDialog.this.getContext());
				amMessage.showMessage(getContext().getString(R.string.checking_now),AnimMessageType.Waitting);
			}
		});
	}
}
